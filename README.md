...
**Nombre:** Hashira Vargas Candia  
**Código:** 2022075480  
**Curso:** Calidad y Pruebas de Software U3  
...
## DESARROLLO
1. Abrir un navegador de internet e ingresar a la pagina de SonarCloud (https://www.sonarsource.com/products/sonarcloud/), iniciar sesión con su cuenta de Github.
...
env:
  ...
  SONAR_ORG: 'hashiravc'                    # Nombre de la organización de sonar cloud
  SONAR_PROJECT: 'hashiravc_bancaapp'       # Key ID del proyecto de sonar
on:
  push:
    branches: [ "main" ]
  workflow_dispatch:
  ...
  coverage:
    ...
    steps:
      ...
      - name: Instalar Scanner
        run: dotnet tool install -g dotnet-sonarscanner --version 6.2.0
